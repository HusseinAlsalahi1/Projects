...
public class Client extends Thread{
	...
	private void readCommand(Pair<String, String> p) {
		listItems.getItems().add(p.toString());
		if(p.getKey().equals("show"))
			listItems.getItems().add(p.getValue());
		else if(p.getKey().equals("scene")) {
			scene = p.getValue();
			listItems.getItems().add("Scene will change to " +scene);
		}
		else if(p.getKey().equals("disable")) {
			listItems.getItems().add(disable + " will be disabled");
			disable = p.getValue();
		}
	...
	public String getScene() {
		listItems.getItems().add("Scene: " + scene + " returned");
		return scene;
	}
	...
	public String getDisable() {
		listItems.getItems().add("disable: " + disable + " returned");
		return disable;
	}
